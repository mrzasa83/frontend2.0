...
import { Save, X, FileText, Package, GitBranch, Route as RouteIcon, ClipboardList, Archive, AlertTriangle, Factory, CheckCircle } from 'lucide-react'
...
export default function ProductEdit({ product, onSave, onCancel }: Props) {
  ...
  const baseMetadata = {
    ...
    fullPath: { label: 'Full Path', type: 'folderLink' as const },
  ...
  // ========================================
  // TAB 4: RELEASED (Files from network folders)
  // ========================================
  const releasedTab = (
    <ReleasedFilesTab partNumber={formData.apcPN} />
  )
