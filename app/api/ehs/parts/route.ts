  ...
  try {
    ...
    const rows = (parts || []).map(p => {
      ...
      return {
        ...
        reach_status: fam?.reach_status || '',
        rohs_status: fam?.rohs_status || '',
        prop65_status: fam?.prop65_status || '',
