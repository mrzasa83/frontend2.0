...
async function GET() {
    ...
    try {
        const users = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mysql$2d$primary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryPrimary"])(`SELECT 
        id,
        username,
        name,
        email,
...
async function POST(request) {
    ...
    try {
        ...
        const existingUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mysql$2d$primary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryPrimary"])('SELECT id FROM Users WHERE username = ?', [
            data.username
        ]);
        ...
        const existingEmail = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mysql$2d$primary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryPrimary"])('SELECT id FROM Users WHERE email = ?', [
            data.email
        ]);
        ...
        // Insert new user
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mysql$2d$primary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryPrimary"])(`INSERT INTO Users (
        username,
        name,
        email,
        nickname,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__07fb89cc._.js.map