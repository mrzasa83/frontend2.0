...
"[project]/frontend2.4/app/api/users/[id]/roles/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, context) {
    ...
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend2$2e$4$2f$lib$2f$db$2f$mysql$2d$primary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryPrimary"])('DELETE FROM user_roles WHERE userId = ?', [
            userId
        ]);
        // Add new roles
        if (roles.length > 0) {
            ...
            const roleRecords = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend2$2e$4$2f$lib$2f$db$2f$mysql$2d$primary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryPrimary"])(`SELECT id, name FROM roles WHERE name IN (${placeholders})`, roles);
            ...
            for (const role of roleRecords){
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend2$2e$4$2f$lib$2f$db$2f$mysql$2d$primary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryPrimary"])('INSERT INTO user_roles (userId, roleId) VALUES (?, ?)', [
                    userId,
                    role.id
                ]);
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ec9af03b._.js.map