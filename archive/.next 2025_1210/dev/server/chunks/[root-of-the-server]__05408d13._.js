...
"[project]/lib/db/mysql-secondary.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/db/mssql.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getMSSQLPool(name) {
    ...
    const pool = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mssql$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].ConnectionPool({
        server: config.host,
        port: config.port,
        user: config.user,
...
"[project]/app/api/admin/query-database/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mysql$2d$primary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/mysql-primary.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mysql$2d$secondary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/mysql-secondary.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mssql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/mssql.ts [app-route] (ecmascript)");
;
;
;
;
...
async function POST(request) {
    ...
    try {
        ...
        const isDangerous = dangerousKeywords.some((keyword)=>{
            ...
            if (hasSemicolon && upperQuery.split(';').some((stmt)=>stmt.trim().startsWith(keyword))) return true;
            return false;
        });
        if (isDangerous) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        try {
            switch(database){
                case 'frontEnd2.0':
                    {
                        const pool = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mysql$2d$primary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getMySQLPrimaryPool"])();
                ...
                case 'Control Center':
                    {
                        const pool = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mysql$2d$secondary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getMySQLSecondaryPool"])();
                        const [rows] = await pool.execute(query);
                        results = rows;
                        if (results.length > 0) {
                            columns = Object.keys(results[0]);
                ...
                case 'Paradigm':
                    {
                        results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mssql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryMSSQL"])('1', query);
                        if (results.length > 0) {
                            columns = Object.keys(results[0]);
                        }
                        break;
                ...
                case 'Engenix':
                    {
                        results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mssql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryMSSQL"])('2', query);
                        if (results.length > 0) {
                            columns = Object.keys(results[0]);
                        }
                        break;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__05408d13._.js.map