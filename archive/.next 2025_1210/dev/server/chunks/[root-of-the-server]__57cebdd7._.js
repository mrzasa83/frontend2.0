...
"[project]/app/api/admin/import-parts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        for (const part of parts){
            try {
                ...
                const existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mysql$2d$primary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryPrimary"])('SELECT id FROM items WHERE apcPN = ?', [
                    part.apcPN
                ]);
                ...
                // Insert new part
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$mysql$2d$primary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryPrimary"])(`INSERT INTO items (
            apcPN,
            customer,
            customerPN,
            currentRev,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__57cebdd7._.js.map