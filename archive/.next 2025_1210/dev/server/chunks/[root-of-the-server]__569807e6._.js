...
"[project]/frontend2.4/app/api/admin/query-database/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        try {
            switch(database){
                case 'frontEnd2.0':
                    {
                        const pool = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend2$2e$4$2f$lib$2f$db$2f$mysql$2d$primary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getMySQLPrimaryPool"])();
                ...
                case 'Control Center':
                    {
                        const pool = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend2$2e$4$2f$lib$2f$db$2f$mysql$2d$secondary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getMySQLSecondaryPool"])();
                        const [rows] = await pool.execute(query);
                        results = rows;
                        if (results.length > 0) {
                            columns = Object.keys(results[0]);
                ...
                case 'Paradigm':
                    {
                        results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend2$2e$4$2f$lib$2f$db$2f$mssql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryMSSQL"])('1', query);
                        if (results.length > 0) {
                            columns = Object.keys(results[0]);
                        }
                        break;
                ...
                case 'Engenix':
                    {
                        results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend2$2e$4$2f$lib$2f$db$2f$mssql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryMSSQL"])('2', query);
                        if (results.length > 0) {
                            columns = Object.keys(results[0]);
                        }
                        break;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__569807e6._.js.map