...
function TopBar() {
    ...
    if ($[8] !== session || $[9] !== userMenuOpen) {
        t5 = userMenuOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                session?.user?.roles && session.user.roles.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
"[project]/components/layout/SideNav.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SideNav(t0) {
    ...
    if ($[0] !== "28b54e6580c92e703427ccf6033f03a0f47112106cfc1c8139aa1777691fe653") {
        for(let $i = 0; $i < 33; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "28b54e6580c92e703427ccf6033f03a0f47112106cfc1c8139aa1777691fe653";
    }
    ...
    const [expandedModules, setExpandedModules] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t1);
    let t2;
    let t3;
    let t4;
    let t5;
    let t6;
    let t7;
    if ($[2] !== expandedModules || $[3] !== isOpen || $[4] !== onToggle || $[5] !== pathname || $[6] !== session?.user?.roles) {
        const isAdmin = session?.user?.roles?.includes("admin") || false;
        let t8;
        if ($[13] !== expandedModules) {
            t8 = ({
        ...
        const toggleModule = t8;
        t7 = `bg-slate-900 text-white transition-all duration-300 flex-shrink-0 ${isOpen ? "w-64" : "w-16"}`;
        t5 = "flex flex-col h-full";
        let t9;
        if ($[15] !== isOpen) {
            t9 = isOpen ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$chevron$2d$left$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ChevronLeft$3e$__["ChevronLeft"], {
                ...
                fileName: "[project]/components/layout/SideNav.tsx",
                lineNumber: 152,
                columnNumber: 21
        ...
        t4 = "flex-1 p-2 overflow-y-auto";
        t2 = "space-y-1";
        t3 = modules.map({
            "SideNav[modules.map()]": (module)=>{
                const Icon = module.icon;
                const hasSubModules = module.subModules && module.subModules.length > 0;
                const isExpanded = expandedModules.has(module.id);
                const isActive = module.path ? pathname.startsWith(module.path) : module.subModules?.some({
                    "SideNav[modules.map() > (anonymous)()]": (sub)=>pathname.startsWith(sub.path)
                }["SideNav[modules.map() > (anonymous)()]"]);
                const visibleSubModules = module.subModules?.filter({
                    "SideNav[modules.map() > (anonymous)()]": (sub_0)=>!sub_0.adminOnly || isAdmin
                }["SideNav[modules.map() > (anonymous)()]"]);
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                    children: [
                        hasSubModules ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            onClick: {
                                "SideNav[modules.map() > <button>.onClick]": ()=>toggleModule(module.id)
                            }["SideNav[modules.map() > <button>.onClick]"],
                            ...
                            children: [
                                ...
                                isOpen && (isExpanded ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$chevron$2d$up$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ChevronUp$3e$__["ChevronUp"], {
                                    size: 16
                                }, void 0, false, {
                                    fileName: "[project]/components/layout/SideNav.tsx",
                                    lineNumber: 181,
                        ...
                        hasSubModules && isExpanded && isOpen && visibleSubModules && visibleSubModules.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                            className: "mt-1 ml-4 space-y-1",
                            children: visibleSubModules.map({
                                "SideNav[modules.map() > visibleSubModules.map()]": (subModule)=>{
                            ...
                            }["SideNav[modules.map() > visibleSubModules.map()]"])
                        }, void 0, false, {
                            fileName: "[project]/components/layout/SideNav.tsx",
                            lineNumber: 181,
                            columnNumber: 897
...
function Footer() {
    ...
    let t1;
    if ($[2] !== debugMode) {
        t1 = debugMode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$layout$2f$SideNav$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/layout/SideNav.tsx [app-client] (ecmascript)");
...
function DashboardLayout(t0) {
    ...
    const { children } = t0;
    const [sideNavOpen, setSideNavOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    let t1;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    if ($[4] !== sideNavOpen || $[5] !== t2) {
        t3 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$layout$2f$SideNav$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
            isOpen: sideNavOpen,
            onToggle: t2
        }, void 0, false, {
            fileName: "[project]/app/(dashboard)/layout.tsx",
...
//# sourceMappingURL=_6885dede._.js.map